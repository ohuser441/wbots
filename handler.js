...
module.exports = {
  async handler(chatUpdate) {
    ...
    try {
	  ...
	  if (!isNumber(user.coin)) user.coin = 20
          if (!isNumber(user.money)) user.money = 1
          if (!isNumber(user.money)) user.multiple = 1
          if (!isNumber(user.limit)) user.limit = 10
          if (!isNumber(user.lastccoin)) user.lastccoin = 0
          ...
          if (!isNumber(user.bankcoin)) user.bankcoin = 0
